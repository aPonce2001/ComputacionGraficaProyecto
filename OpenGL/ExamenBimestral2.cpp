...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.setFloat("pointLights[0].constant", 0.025f);
		...
		lightingShader.setFloat("pointLights[1].constant", 0.025f);
		...
		lightingShader.setFloat("pointLights[2].constant", 0.025f);
		...
		lightingShader.setFloat("pointLights[3].constant", 0.025f);
		lightingShader.setFloat("pointLights[3].linear", 0.009f);
		...
		lightingShader.setFloat("pointLights[4].constant", 0.025f);
		lightingShader.setFloat("pointLights[4].linear", 0.009f);
		lightingShader.setFloat("pointLights[4].quadratic", 0.0032f);
		//point light 6
		...
		lightingShader.setFloat("pointLights[5].constant", 0.025f);
		lightingShader.setFloat("pointLights[5].linear", 0.009f);
		lightingShader.setFloat("pointLights[5].quadratic", 0.0032f);
		//point light 7
		...
		lightingShader.setFloat("pointLights[6].constant", 0.025f);
		lightingShader.setFloat("pointLights[6].linear", 0.009f);
		lightingShader.setFloat("pointLights[6].quadratic", 0.0032f);
